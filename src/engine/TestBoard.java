...
public class TestBoard extends BoardAbstract{
    ...
    private void initBoard() {
        ...
        CompositeFactory.addScriptTo(insect, new EntityBehaviorScript.QuadraticFollow(insect, player));
		...
		currentScene.addBackgroundSprite(4,
				EntityFactory.createBackgroundSprite("Prototypes/starcloud03.png", 0 , 0 ));
		...
		currentScene.addBackgroundSprite(3,
				EntityFactory.createBackgroundSprite("Prototypes/starcloud01.png", 0 , 0 ));
		currentScene.addBackgroundSprite(3,
				EntityFactory.createBackgroundSprite("Prototypes/starcloud01.png", 0 , -2000 ));
